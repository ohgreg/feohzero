...
const int bishop_shift[64] = {58, 59, 59, 59, 59, 59, 59, 58, 59, 59, 59, 59, 59, 59, 59, 59, 59, 59, 57, 57, 57, 57, 59, 59, 59, 59, 57, 55, 55, 57, 59, 59,
...
U64 generate_pinmask(Board *board, int pos) {
    ...
    U64 pinmask = 0;
    U64 *slide_mask[4] = {bishop_lmask, bishop_rmask, rook_lmask, rook_rmask};
    for (int i = 0; i < 4; i++) {
