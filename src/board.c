...
//                         == 0){ start_pos = 8*(final_rank+k1) + final_file+k2;
//                         if(IS_SET_BIT(Board->occupied[2], start_pos) &&
//                         !IS_SET_BIT(Board->pieces[turn][BISHOP], start_pos))
//                             dir[j] = 1;
//                         else
//                             return start_pos;
//                     }
...
//                 move.start_pos = findOrigin(Board, -1, -1, piece, final_rank,
//                 final_file);
//             }
